export const ERC20_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: 'protocolCouncil', type: 'address' },
      { internalType: 'address', name: 'emergencyCouncil', type: 'address' }
    ],
  ...
  { inputs: [], name: 'InvalidShortString', type: 'error' },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'mintRequested', type: 'uint256' }
    ],
