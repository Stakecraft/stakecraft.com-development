            ...
            <div class="network-info">
              ...
              <div v-if="stakingError" class="error-message">
                ...
                <div v-if="stakingError.includes('not installed')" class="install-guide">
                  ...
                  <ol>
                    ...
                    <li>Add the ZetaChain network to your Keplr wallet</li>
              ...
              <div class="staking-form" v-if="walletConnected">
                <div class="form-group">
                  <label>Amount to Stake (ZETA)</label>
              ...
              <div class="staking-info" v-if="walletConnected">
                ...
                <div class="info-grid">
                  <div class="info-item">
                    ...
                    <span class="value">{{ stakedAmount }} ZETA</span>
                  </div>
                  <div class="info-item">
                    <span class="label">Rewards Earned:</span>
                    <span class="value">{{ rewardsEarned }} ZETA</span>
                  </div>
                  <div class="info-item">
