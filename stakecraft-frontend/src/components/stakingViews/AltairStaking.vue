          ...
          <div v-if="walletError" class="wallet-warning">
            ...
            <div class="warning-content">
              ...
              <p class="warning-message">
                To use Altair staking, you need to install the Polkadot.js extension.
              </p>
            </div>
          </div>
          ...
          <div v-if="walletConnected">
            <div class="wallet-info-card">
              ...
              <div v-if="transactionHash" class="transaction-info">
                <div class="wallet-info-row">
                  ...
                  <a
                    :href="`https://altair.subscan.io/extrinsic/${transactionHash}`"
                    target="_blank"
            ...
            <div v-if="activeTab === 'stake'" class="tab-content">
              <div class="staking-form">
                ...
                <div class="form-group">
                  <label class="form-label">Amount to Stake (AIR)</label>
                  ...
                  <div class="input-hint">
                    <span>Minimum: {{ minimumStake }} AIR</span>
                    <button
                ...
                <div class="info-card">
                  ...
                  <div class="info-card-content">
                    <div class="info-row">
                      ...
                      <span class="info-value">{{ availableBalance }} AIR</span>
                    </div>
                    <div class="info-row">
                      <span class="info-label">Currently Staked:</span>
                      <span class="info-value">{{ stakedAmount }} AIR</span>
                    </div>
                    <div class="info-row">
                      <span class="info-label">Staking Rewards:</span>
                      <span class="info-value">{{ stakingRewards }} AIR</span>
                    </div>
                  </div>
                </div>
                ...
                <div v-if="stakingSuccess" class="success-message">
                  Successfully staked {{ stakeAmount }} AIR!
                </div>
                ...
                >
                  {{ isProcessing ? 'Processing...' : 'Stake AIR' }}
                </button>
              </div>
            </div>
            ...
            <div v-if="activeTab === 'unstake'" class="tab-content">
              <div class="staking-form">
                ...
                <div class="form-group">
                  <label class="form-label">Amount to Unstake (AIR)</label>
                  <div class="input-container">
                    <input
                  ...
                  <div class="input-hint">
                    <span>Available to unstake: {{ stakedAmount }} AIR</span>
                    <button
                ...
                <div class="warning-card">
                  ...
                  <div class="warning-text">
                    <strong>Important:</strong> Unstaked AIR tokens will be locked for 28 days
                ...
                <div v-if="unstakingSuccess" class="success-message">
                  Successfully unstaked {{ unstakeAmount }} AIR!
                </div>
                ...
                >
                  {{ isProcessing ? 'Processing...' : 'Unstake AIR' }}
                </button>
              </div>
            </div>
