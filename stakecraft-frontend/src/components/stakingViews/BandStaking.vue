          ...
          <div v-if="walletConnected">
            <div class="wallet-info-card">
              ...
              <div v-if="transactionHash" class="transaction-info">
                <div class="wallet-info-row">
                  ...
                  <a
                    :href="`https://cosmoscan.io/band/tx/${transactionHash}`"
                    target="_blank"
            ...
            <div v-if="activeTab === 'stake'" class="tab-content">
              <div class="staking-form">
                ...
                <div class="info-card">
                  ...
                  <div class="info-card-content">
                    <div class="info-row">
                      ...
                      <span class="info-value">{{ availableBalance }} BAND</span>
                    </div>
                    <div class="info-row">
                      <span class="info-label">Currently Staked:</span>
                      <span class="info-value">{{ stakedAmount }} BAND</span>
                    </div>
                  </div>
                </div>
                ...
                >
                  {{ isProcessing ? 'Processing...' : 'Delegate BAND' }}
                </button>
              </div>
            </div>
            ...
            <div v-if="activeTab === 'unstake'" class="tab-content">
              <div class="staking-form">
                ...
                <div class="form-group">
                  <label class="form-label">Amount to Unstake (BAND)</label>
                  <div class="input-container">
                    <input
                ...
                <div class="info-card">
                  ...
                  <div class="info-card-content">
                    ...
                    <div class="info-row">
                      ...
                      <span class="info-value">{{ rewardsEarned }} BAND</span>
                    </div>
                    <div class="info-row">
                ...
                >
                  {{ isProcessing ? 'Processing...' : 'Undelegate BAND' }}
                </button>
              </div>
            </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const refreshStakingInfo = async () => {
      ...
      try {
        const bandBalance = await getBandBalance(walletAddress.value)
        totalBandBalance.value = bandBalance
        availableBalance.value = Number(bandBalance).toFixed(4)
